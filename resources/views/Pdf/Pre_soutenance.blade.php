...
<head>
    ...
    <title>Programme des pré-soutenances</title>
</head>
<style>
            ...
            <tbody>
                @foreach ($soutenancesGroupedByExaminateurPresident as $examinateurPresident => $soutenancesExaminateurPresident)
                    <tr>
                        ...
                        <td>
                            @if ($filieresParExaminateurPresident[$examinateurPresident]->count() > 1)
                                {{ implode(' ; ', $filieresParExaminateurPresident[$examinateurPresident]->toArray()) }}
                            @else
                                {{ $filieresParExaminateurPresident[$examinateurPresident]->first() }}
                            @endif
                        </td>
